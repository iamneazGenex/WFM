...
def tradeDetails(self):
    return f"<br><b>Trading Details</b><br>Trade Date:{self.requestee_swap_roster.start_date}<br>Requestor:{self.requestor.user.name}<br>Current Roster Time:{self.requestor_start_time} To {self.requestor_end_time}<br><br><br>Requestee:{self.requestee.user.name}<br>Current Roster Time:{self.requestee_start_time} To {self.requestee_end_time}<br><br>"
